...
adjacent on the right bottom row and is letter-then-punctuation, not a letter roll. Enter is
also on the raise layer at the inner left thumb, so a one-shot or held `rse` reaches it
without a chord.
